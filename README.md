...
- Når begge projekter er loaded, skal både consollen for TodoAPI og output-vinduet for TodoREST vises.

##### Polly med RetryAsync policy

1. Mobil clienten prøver 10 gange, hvilket kan ses i console vinduet for TodoAPI og i Output-vinduet for TodoREST.
2. Når den prøver den 11. gang, opstår der en `HttpRequestExceptionEx`.
...
2. Nu prøver clienten 5 gange med 3 sekunders mellemrum.
2. Når den prøver den 6. gang, opstår der en `HttpRequestExceptionEx`.
